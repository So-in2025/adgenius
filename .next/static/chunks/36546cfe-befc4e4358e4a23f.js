"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[315],{3871:function(e,t,r){r.d(t,{B:function(){return signOut},a8:function(){return createUserWithEmailAndPassword},a9:function(){return signInWithEmailAndPassword},o:function(){return getAuth},x:function(){return onAuthStateChanged}});var i=r(8745),n=r(3991),s=r(44),a=r(6914),o=r(5538);function _prodErrorMap(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}let l=_prodErrorMap,u=new i.LL("auth","Firebase",_prodErrorMap()),c=new a.Yd("@firebase/auth");function _logWarn(e,...t){c.logLevel<=a.in.WARN&&c.warn(`Auth (${n.Jn}): ${e}`,...t)}function _logError(e,...t){c.logLevel<=a.in.ERROR&&c.error(`Auth (${n.Jn}): ${e}`,...t)}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function _reloadWithoutSaving(e){var t;let r=e.auth,i=await e.getIdToken(),n=await _logoutIfInvalidated(e,getAccountInfo(r,{idToken:i}));_assert(null==n?void 0:n.users.length,r,"internal-error");let s=n.users[0];e._notifyReloadListener(s);let a=(null===(t=s.providerUserInfo)||void 0===t?void 0:t.length)?extractProviderData(s.providerUserInfo):[],o=mergeProviderData(e.providerData,a),l=e.isAnonymous,u=!(e.email&&s.passwordHash)&&!(null==o?void 0:o.length),c={uid:s.localId,displayName:s.displayName||null,photoURL:s.photoUrl||null,email:s.email||null,emailVerified:s.emailVerified||!1,phoneNumber:s.phoneNumber||null,tenantId:s.tenantId||null,providerData:o,metadata:new UserMetadata(s.createdAt,s.lastLoginAt),isAnonymous:!!l&&u};Object.assign(e,c)}async function reload(e){let t=(0,i.m9)(e);await _reloadWithoutSaving(t),await t.auth._persistUserIfCurrent(t),t.auth._notifyListenersIfCurrent(t)}function mergeProviderData(e,t){let r=e.filter(e=>!t.some(t=>t.providerId===e.providerId));return[...r,...t]}function extractProviderData(e){return e.map(e=>{var{providerId:t}=e,r=(0,s._T)(e,["providerId"]);return{providerId:t,uid:r.rawId||"",displayName:r.displayName||null,email:r.email||null,phoneNumber:r.phoneNumber||null,photoURL:r.photoUrl||null}})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
